...
<footer class="container-fluid logoBack text-light">
  <div class="row py-5">
    <div class="col-12 col-md-4 d-flex justify-content-center align-items-center">
      <img class="logo_footer rounded-circle" src="images/logo_trans-min.png" alt="logo de l'Association ANERANA">
        </div>
        ...
        <a class="btn btn-warning" href="https://gnut06-my.sharepoint.com/:b:/g/personal/gnut_gnut06_org/EXKbqqaCxbpMhq2SmF_Yj5YB5xUwp2ZhkdYVRKPBeAmPRg?e=lfmHjI" target="_blank">Journal Officiel</a>
        </div>
    <div class="col-12 col-md-4 text-center d-flex flex-column align-self-center mt-5">
      <h5 class="fs-3">Association ANERANA</h5>
      <p>16 Rue Bavastro
      06300 Nice <br>
        FRANCE</p>
      <p class="fs-4">Téléphone : +33663761443</p>
      <br>
