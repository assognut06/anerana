      ...
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <!-- <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="https://gnut06.sharepoint.com/sites/Gnut06" target="_blank">Le Hub ANERANA sur notre portail Microsoft</a></li>
            <li><a class="dropdown-item <?= (!empty($_GET['page']) && $_GET['page'] == "accueilGnut06") ? "active" : "" ?>" href="?page=accueilGnut06">Salle d'initialtion au métaverse ANERANA</a></li>
